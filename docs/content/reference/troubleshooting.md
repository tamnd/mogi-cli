...
Most of these come down to network reality or how mogi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mogi rate-limits like any public site. mogi already paces
...
Where a surface is gated, mogi reads a cookie or token you supply
...
`mogi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mogi actually did
